...
module.exports.bootstrap = async function() {
  ...
  */
  ...
  var jwPark = await User.create(
    {
      emailAddress: 'park363@daum.net',
      fullName: 'JW Park',
      isSuperAdmin: true,
      password: await sails.helpers.passwords.hashPassword('bk813102')
     }
    ).fetch();

  console.log("********* addToCollection " + jwPark.id + " : " + ryanDahl.id);
  await User.addToCollection(jwPark.id, 'friends', ryanDahl.id);
